...
from DMCE import DiffusionModel, CNN
...
def args_parser():
    ...
    parser.add_argument('--dataset_name', default='CDL-D', type=str, help="Name of the training dataset")
...
def main():
    ...
    args.log_path = './DMCE_checkpoints/DMCE/%s_Nt%d_Nr%d_ULA' % (args.dataset_name, args.img_size[1], args.img_size[0])
